      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              UserFirstName = res.data.data.user.name.split(' ')[0];
              (0, _alerts.showAlert)('success', "".concat(UserFirstName, ", Welcome to Natours!"));
              window.setInterval(function () {
                location.assign('/me');
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2lrbzgxYiIsImEiOiJjazgwYWlpYW4wZjF6M2V1bjF6eGRpYnIwIn0.gyjVJ6ogR_0QTL2d17f-mQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend the map bounds
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You successfully updated your details.');
              window.setInterval(function () {
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"previewImage.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_jqtBB6dYbTq53iWaTJsvMByM006afw9wkh');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Oops, something went wrong, please try later!');
...
var photoUploadForm = document.querySelector('.form__upload');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return (0, _login.default)(email, password);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _signup.default)(name, email, password, passwordConfirm);
...
if (logoutButton) {
  logoutButton.addEventListener('click', _logout.default);
}

if (photoUploadForm) {
  photoUploadForm.addEventListener('change', function (e) {
    (0, _previewImage.default)(e);
  });
}
